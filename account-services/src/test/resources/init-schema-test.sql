...
INSERT INTO cuentas (numero, tipo, saldo_inicial, estado) VALUES
((FLOOR(RAND() * 1000000)), 'AHORROS', 1000.00, TRUE),
((FLOOR(RAND() * 1000000)), 'CORRIENTE', 2000.00, TRUE),
((FLOOR(RAND() * 1000000)), 'AHORROS', 1500.00, TRUE),
((FLOOR(RAND() * 1000000)), 'CORRIENTE', 3000.00, TRUE),
((FLOOR(RAND() * 1000000)), 'AHORROS', 2500.00, TRUE),
((FLOOR(RAND() * 1000000)), 'CORRIENTE', 4000.00, TRUE),
((FLOOR(RAND() * 1000000)), 'AHORROS', 3500.00, TRUE),
((FLOOR(RAND() * 1000000)), 'CORRIENTE', 5000.00, TRUE),
((FLOOR(RAND() * 1000000)), 'AHORROS', 4500.00, TRUE),
((FLOOR(RAND() * 1000000)), 'CORRIENTE', 6000.00, TRUE);
